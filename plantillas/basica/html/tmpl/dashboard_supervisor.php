  <?php
    ...
    $num_celebrados = $ContratosModel->getNumCelebradosSupervisor();
    $num_liquidados = $ContratosModel->getNumLiquidadosSupervisor();
  ...
  <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
              <a href="#" onclick="cargar_contratos_supervisor_x_estado(3);">
            ...
            <div class="col-md-3">
              <a href="#" onclick="cargar_contratos_supervisor_x_estado(4);">
                <div class="info-box mb-3">
                  <span class="info-box-icon bg-success elevation-1"><i class="fas fa-list-alt"></i></span>
