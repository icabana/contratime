<?php
    ...
    $this->excel->setActiveSheetIndex(0)            
        ->setCellValue('A1', 'No.')
        ->setCellValue('B1', 'Nombre de la Modalidad de Contratación');
    ...
    foreach($modalidades as $modalidad){                            
        ...
        $this->excel->setActiveSheetIndex(0)
             ...
             ->setCellValue('B'.$columna, $modalidad['nombre_modalidad']);
    ...
    $this->excel->getActiveSheet()->setTitle('Reporte de Modalidades');
