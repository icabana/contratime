<div class="modal fade" id="modal_prorrogas" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">        
        <button onclick="agregar_prorroga();" type="button" class="btn btn-primary">Agregar</button>
      </div>
