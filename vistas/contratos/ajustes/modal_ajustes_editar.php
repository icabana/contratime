<div class="modal fade" id="modal_ajustes_editar" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">        
        <button onclick="agregar_ajuste_editar();" type="button" class="btn btn-primary">Agregar</button>
      </div>
    </div>
  </div>
</div>
