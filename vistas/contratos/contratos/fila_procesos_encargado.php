                  ...
                  <td class="mailbox-subject">
                    ...
                    <?php 
                        if($contrato['estado_contrato'] == 1 ){
                            ...
                            echo '<td class="mailbox-subject">';
                            echo '<center><button onclick="sel_adjudicar_contrato_encargado(' . $id_contrato . ');"  title="Adjudicar Contrato" data-toggle="modal" data-target="#modal_adjudicar" type="button" class="btn btn-success btn-xs ">¿Adjudicar?</button></center>';
