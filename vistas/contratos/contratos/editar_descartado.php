    ...
    <div style="padding: 25px" class="box-body">
      ...
      <div class="card card-primary">
        ...
        <div class="card-header">
          <h3 class="card-title">Editar Contrato Descartado (Estado Actual: <?php echo $contrato['nombreestado_contrato']; ?>)</h3>
        </div>
          ...
          <div class="tab-content">
            ...
            <div style="padding: 20px; " class="tab-pane active" id="tab_1">
              ...
              <?php
                  ...
                  include("vistas/contratos/contratos/form_contrato_descartado.php");
