          ...
          <table id="tabla_contratos" style="width:100%; font-size:12px" class="table table-hover table-striped">
            <thead>
              <tr>
                ...
                <th style='background-color:lavender; width:15%'>Contratista</th>
                <th style='background-color:lavender; width:10%'>Valor </th>
                <th style='background-color:lavender; width:20%'>Objeto</th>                        
                <th style='background-color:lavender; width:20%'>Observaciones</th>                        
                <th style='background-color:lavender; width:5%'>Acciones</th>         
                <?php
                 if($_SESSION['rol'] == 1){
                ?>
            ...
            <tbody>
              ...
              ?>
                <tr id="fila_contrato_<?php echo $contrato['id_contrato']?>" >
                  ...
                  <td class="mailbox-subject">
                    <?php echo utf8_encode(substr($contrato['obsdel'], 0, 90)) . "..."; ?>
                  </td>
