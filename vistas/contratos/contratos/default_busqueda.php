      ...
      <div class="card-header">
        <div class="box">
          <div class="row">
            ...
            <div class="col-md-2">
             <button onclick="busqueda_avanzada(); return false;" class="btn btn-primary btn-sm">
                Regresar a Busqueda Avanzada
              </button>
            </div>
            <div class="col-md-8">
            <h4 style="color:grey"><center>LISTADO DE CONTRATOS ENCONTRADOS EN LA BUSQUEDA</center></h4>
            </div>
            <div class="col-md-2">
