              ...
              ?>
                <tr id="fila_contrato_<?php echo $contrato['id_contrato']?>" >
                  ...
                  <?php
                    ...
                    echo "<td><a class='btn btn-sm btn-primary' style='padding:5px 11px 5px 11px' href='#' onclick='editar_contrato_contratista(" . $contrato['id_contrato'] . ");' title='Ver Detalle Contrato'><i 
