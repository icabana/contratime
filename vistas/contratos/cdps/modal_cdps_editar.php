<div class="modal fade" id="modal_cdps_editar" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="col-md-12">
            ...
            <label>N&uacute;mero del CDP: </label>
      ...
      <div class="modal-footer">        
        <button onclick="agregar_cdp_editar();" type="button" class="btn btn-primary">Agregar</button>
      </div>
    </div>
  </div>
</div>
