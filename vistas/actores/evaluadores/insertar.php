  ...
  <form autocomplete="on" id="formEvaluadores" method="post">
    ...
    <div class="card card-primary">
      ...
      <div class="card-header">
        <h3 class="card-title">Agregar Nuevo Evaluador</h3>
      </div>
      ...
      <div class="card-body" style="height: 400px">
            ...
            <div class="tab-content">
              ...
              <div style="padding: 20px;" class="tab-pane active" id="tab_1">
                ...
                <?php
                  include("vistas/actores/evaluadores/insertar_tab1.php");
                ?>
              ...
              <div style="padding: 20px;" class="tab-pane" id="tab_2">
                ...
                <?php
                  include("vistas/actores/evaluadores/insertar_tab2.php");
                ?>
              ...
              <div style="padding: 20px;" class="tab-pane" id="tab_3">
                ...
                <?php
                  include("vistas/actores/evaluadores/insertar_tab3.php");
                ?>
        ...
        <div class="card-footer">
          <div class="row">
            ...
            <div class="col-md-3">
              <button onclick="insertar_evaluador(); return false;" class="btn btn-success">Guardar</button>
            </div>     
          </div>     
        </div>     
