<?php
    ...
    $this->pdf->SetTitle('Reporte de Evaluadores');
    ...
    $this->pdf->Cell(0, 10, "REPORTE DE EVALUADORES", 0, 1, "C");
    $y = $this->pdf->GetY();    
    ...
    foreach ($evaluadores as $evaluador) {
        ...
        $this->pdf->Row(
            array(
                $cont,
                $evaluador['codigo_tipodocumento']." ".$evaluador['documento_evaluador'],
                $evaluador['nombre_evaluador'],
                $evaluador['correo_evaluador']
            )
        );
