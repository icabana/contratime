<script type="text/javascript" src="js/vistas/actores/encargados/default.js"></script>
  ...
  <form autocomplete="on" id="formEncargados" method="post">
    ...
    <div class="card card-primary">
      ...
      <div class="card-header">
        <h3 class="card-title">Editar Encargado</h3>
      </div>
      ...
      <div class="card-body"  style="height: 400px">
            ...
            <div class="tab-content">
              ...
              <div style="padding: 20px;" class="tab-pane active" id="tab_1">
                ...
                <?php
                  include("vistas/actores/encargados/editar_tab1.php");
                ?>
              ...
              <div style="padding: 20px;" class="tab-pane" id="tab_2">
                ...
                <?php
                  include("vistas/actores/encargados/editar_tab2.php");
                ?>
              ...
              <div style="padding: 20px;" class="tab-pane" id="tab_3">
                ...
                <?php
                  include("vistas/actores/encargados/editar_tab3.php");
                ?>
