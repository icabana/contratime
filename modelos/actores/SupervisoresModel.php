...
class SupervisoresModel extends ModelBase {  
 ...
 from supervisores
    ...
    $query = "  
        ...
        nombres_supervisor = '".$nombres_supervisor."',
        apellidos_supervisor = '".$apellidos_supervisor."', 

        dirresidencia_supervisor = '".$dirresidencia_supervisor."', 
        dircorrespondencia_supervisor = '".$dircorrespondencia_supervisor."', 
